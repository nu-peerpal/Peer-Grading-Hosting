...
class Dashboard extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      List: [
        {
          name: "Grade User 1s Submission",
          info: "Assignment 2: Bid Analysis",
        },
        {
          name: "Grade User 2s Submission",
          info: "Assignment 2: Bid Analysis",
        },
        {
          name: "Grade User 3s Submission",
          info: "Assignment 2: Bid Analysis",
        },
  ...
  componentDidMount() {
    ...
    peerMatch(
      ...
      js.peer_load,
      js.grader_load
    ).then((data) => console.log("PeerMatch", data));
    js = {
      graders: [1, 3, 2],
      reviews: [
        [
    ...
    ensureSufficientReviews(js.graders, js.reviews, js.matching).then((data) =>
      console.log("SufficientReviews", data)
    );
    js = {
      graders: [3, 1, 2],
      reviews: [
    ...
    submissionReports(
      ...
      js.num_rounds,
      js.bonus
    ).then((data) => console.log("SubmissionReports", data));
    js = {
      graders: [3, 1, 2],
      reviews: [
        [
    ...
    reviewReports(js.graders, js.reviews, js.rubric).then((data) =>
      console.log("ReviewReports", data)
    );
  }
